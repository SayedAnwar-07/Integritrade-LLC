 ...
 *
 * Regenerates all data/areas/<city>Data.ts files from Ian's approved master
 * article drafts (2026-07-21). City names are substituted deterministically
 * into the approved templates; article copy is not rewritten by the script.
 *
 * The script also creates any missing Southern California city data files from
 * the latest client service-area expansion request. Existing city files are
 * never replaced during the seed step; they are only regenerated by the normal
 * article pipeline below.
 *
 * Usage: node scripts/generate-city-articles.mjs
 */
...
const HARD_DRIVE_SHREDDING = {
  ...
  heroSubheading:
    "Protect your organization from data breaches with certified hard drive destruction, an unbroken chain of custody, and environmentally responsible recycling.",
  details: [
    {
...
When a device is processed through an industrial shredder, extreme shearing force breaks down the drive housing, platters, and circuit boards. For Solid State Drives (SSDs) and flash storage, specialized precision shredding reduces the media to 2mm particles, physically destroying the individual NAND flash memory chips. This level of physical destruction eliminates any possibility of forensic reconstruction, making it the gold standard for organizations handling sensitive customer PII, financial records, healthcare data, or intellectual property.`,
    ...
    {
      heading: "Why {{CITY}} Organizations Require Physical Media Destruction",
      body: "For organizations operating in {{CITY}}, professional shredding services are a fundamental component of enterprise risk management:",
      bullets: [
        "Unbroken Chain of Custody: From the moment assets are collected at your {{CITY}} facility to final physical processing, every step is logged, tracked, and verified through GPS monitored logistics.",
    ...
    {
      heading: "Offsite and Video-Taped Shredding Workflows in {{CITY}}",
...
Whether you need onsite mobile shredding at your {{CITY}} office or offsite processing for a large scale data center decommission, Integritrade provides the security, compliance, and legal documentation your organization needs.

Contact our {{CITY}} data destruction team today for a quote or to schedule certified hard drive shredding for your organization.`,
    },
  ],
};
...
const IT_ASSET_DISPOSITION = {
  ...
  heroSubheading:
    "Secure data destruction, enterprise hardware liquidation, and compliant IT asset disposal for {{CITY}} organizations.",
  details: [
    {
      heading: "Introduction",
      body: `When organizations upgrade their technology infrastructure or retire outdated servers, they face a critical operational challenge: how to decommission hardware safely without exposing sensitive data. Professional IT Asset Disposition (ITAD) provides the solution. If you manage an enterprise, healthcare facility, or data center in {{CITY}} and need to retire equipment, working with a certified ITAD partner ensures complete risk mitigation.

At Integritrade, we provide comprehensive IT Asset Disposition services in {{CITY}}. From certified data destruction and data center decommissioning to hardware remarketing and electronic waste recycling, we deliver secure solutions tailored to your compliance requirements.`,
    },
    {
...
Professional ITAD goes beyond basic recycling. It combines NIST 800-88 compliant data wiping, physical media destruction, unbroken chain of custody logistics, and hardware value recovery. Partnering with an ITAD provider in {{CITY}} allows your organization to uphold regulatory compliance, protect intellectual property, and capture maximum return on investment from retired technology.`,
    },
    {
      heading: "Why {{CITY}} Businesses Require Certified ITAD",
      body: "Proper IT asset retirement addresses critical security, legal, and financial priorities:",
      bullets: [
        "Data Breach Prevention: Disposing of storage media without verified sanitization creates immense liability. We protect {{CITY}} organizations against data breach risks through rigorous physical and logical destruction protocols.",
        ...
        "HIPAA Compliant Computer Disposal: Healthcare providers and business associates in {{CITY}} require specialized destruction workflows to ensure patient data is permanently destroyed.",
    ...
    {
      heading: "Comprehensive ITAD Services Offered in {{CITY}}",
    ...
    },
    {
      ...
      body: "Decommissioning a data center in {{CITY}} requires meticulous planning. Our technicians handle cable removal, rack itemization, asset tagging, secure packing, and specialized transport for high density server environments.",
    },
    {
    ...
    },
    {
      ...
      bullets: [
        "Inventory and Site Pickup: We log every asset at your {{CITY}} facility, and can document serial numbers on-site to create a clear manifest, depending on your security needs.",
...
const ELECTRONICS_RECYCLING = {
  ...
  heroSubheading:
    "For businesses and consumers across {{CITY}}, deciding how to retire old IT assets and electronic waste is more than just a housekeeping task. It is a critical security, compliance, and environmental decision. Whether you are decommissioning a data center, refreshing an office full of laptops, or simply looking for responsible e-waste disposal, choosing the right electronics recycling partner is essential - and industry certifications are non-negotiable. Any vendor can claim to be certified, but the real question is: by whom?",
  details: [
    {
      heading: "",
      body: "From downtown {{CITY}} offices and healthcare providers to local research facilities, organizations generate a steady stream of retired technology that requires secure handling. Improper electronic waste disposal harms the environment and exposes your organization to data breaches and regulatory penalties. Integritrade serves organizations throughout {{CITY}} and stands out as the premier choice for secure, compliant, and sustainable IT Asset Disposition (ITAD) and electronics recycling.",
    },
    {
    ...
    },
    {
      ...
      bullets: [
        "Unbroken Chain of Custody: We can provide serialized accountability from your loading dock in {{CITY}} to the downstream processor. Every ITAD asset can be scanned and inventoried, depending on your organization’s security requirements, leaving zero blind spots in your audit trail.",
    ...
    },
    {
      ...
      qna: [
        ...
        },
        {
          ...
          answer:
            "Security begins the moment your assets leave your {{CITY}} location. We use secure GPS-monitored logistics and once your retired devices arrive at our facility, your equipment is handled exclusively by our background checked professionals under 24/7 video surveillance until final disposition.",
        },
      ],
    },
  ],
...
const CERTIFICATES_OF_DESTRUCTION = {
  ...
  heroHeading: "Secure Certificates of Destruction for IT Assets in {{CITY}}",
  heroSubheading:
    "When organizations in {{CITY}} retire their aging technology, simple disposal is never an option. Corporate data breaches, regulatory fines, and intellectual property theft are severe risks associated with improper electronics recycling. To protect your enterprise, you need verifiable, audit ready documentation proving that your proprietary data no longer exists.",
  details: [
    {
      heading: "",
      body: "At Integritrade, we provide {{CITY}} businesses with fully compliant IT asset disposition and secure data destruction services, culminating in a legally binding Certificate of Destruction for every processed device.",
    },
    {
...
Whether you manage a small, medium, or larger enterprise, a healthcare network, or a massive data center in {{CITY}}, retaining these certificates is a mandatory component of responsible information governance.`,
    },
    {
      heading: "The Integritrade Chain of Custody in {{CITY}}",
      body: "A Certificate of Destruction is only as reliable as the security protocols supporting it. From the moment our team arrives at your {{CITY}} facility, we maintain strict control of your assets.",
      bullets: [
    ...
    {
      heading: "Why {{CITY}} Businesses Demand Certified ITAD",
      body: `Relying on uncertified vendors exposes your {{CITY}} organization to catastrophic legal and financial risks. Integritrade protects your business by operating under the most stringent, independently audited frameworks in the electronics recycling industry.
...
When you receive a Certificate of Destruction from our team, it is backed by five distinct third party certifications:`,
    ...
    },
    {
      ...
      body: "Do not leave your enterprise data vulnerable when decommissioning hardware. Partner with Integritrade for secure IT asset disposition and receive the ironclad Certificates of Destruction your compliance officers require. Contact our {{CITY}} team today to schedule a secure pickup, request transport containers, or discuss your customized data destruction requirements.",
    },
  ],
};
...
const DATA_CENTER_DECOMMISSIONING = {
  ...
  heroHeading:
    "Data Center Decommissioning in {{CITY}}: Secure, Certified Cleanouts for Every Scale",
  heroSubheading:
    "A data center decommission is one of the most operationally complex and data-sensitive projects an organization can undertake. Whether you are clearing a single cage in a colocation facility, retiring a dedicated server room, or decommissioning an entire multi-floor enterprise data center in {{CITY}}, the stakes are high on every front - data security, regulatory compliance, asset recovery, logistics, and timeline.",
  details: [
    {
      heading: "",
      body: `Most organizations only do this a handful of times. We at Integritrade provide end-to-end data center decommissioning and cleanout services for businesses, healthcare systems, financial institutions, government agencies, colocation facilities, and enterprises throughout {{CITY}} and all of California - from a single rack to a full facility teardown.
...
Done correctly, a data center decommission recovers significant financial value from the equipment being retired, produces a complete and auditable chain-of-custody record, and leaves the facility clean, documented, and ready for its next use. Done incorrectly, it creates data liability, missed recovery value, and compliance gaps that can surface months or years later.`,
    ...
    {
      heading: "Who Needs Data Center Decommissioning Services in {{CITY}}?",
      body: "Data center cleanouts are not limited to large enterprises. Integritrade handles decommissioning projects of every scale for organizations across {{CITY}} and California, including:",
      bullets: [
    ...
    {
      heading: "",
      body: "Whether your {{CITY}} data center is a 10-rack server room or a 10,000 square foot facility, Integritrade has the equipment, personnel, and certified processes to manage the full decommission.",
    },
    {
    ...
    },
    {
      ...
      body: "For organizations that require destruction to occur at the {{CITY}} data center location - whether for security policy reasons, contractual requirements, or timeline constraints - Integritrade provides on-site destruction services including degaussing, manual crushing, and hard drive destruction at your facility. For equipment requiring full shredding, on-site crushing can be performed to render drives inoperable before transport to our Fresno facility for final shredding and documentation.",
    },
    {
    ...
    {
      heading:
        "TraceTech: Real-Time Visibility Across Your Entire Decommission",
...
Integritrade holds the industry's most comprehensive certification stack for this work:`,
    ...
    },
    {
      ...
      body: `When evaluating data center decommissioning providers in {{CITY}}, one of the most important questions to ask is whether data destruction is performed in-house or outsourced to a downstream vendor.
...
Integritrade performs data destruction in-house at our Fresno facility. When we issue a Certificate of Destruction, the destruction was performed at our facility, under our certified processes, documented by our systems, and verifiable through our chain-of-custody records. For large equipment requiring partner-facility shredding, we use witnessed destruction at certified partner facilities with full photo, weight, and witness documentation included in your project record.`,
    ...
    {
      heading: "Serving {{CITY}} and All of California",
      ...
      qna: [
        {
          ...
          answer:
            "Data center decommissioning is the structured process of retiring, removing, and securely disposing of IT infrastructure from a data center environment. It includes servers, storage arrays, networking equipment, rack enclosures, cabling, power systems, and other hardware, along with certified data destruction and full chain-of-custody documentation for every asset.",
        },
        {
          question: "How long does a data center decommission take?",
          answer:
            "Timeline depends on the scale and complexity of the project. A single server room or cage can typically be completed in one to two days. A full data center decommission may take several days to several weeks depending on asset volume, access requirements, and documentation scope. Integritrade provides a timeline as part of the project scoping process.",
        },
        {
          question:
            "Does Integritrade perform data destruction on-site at the data center?",
          answer:
            "Yes. Integritrade offers on-site data destruction including degaussing, manual crushing, and hard drive destruction at your {{CITY}} facility. For equipment requiring full shredding, on-site crushing renders drives inoperable before transport to our Fresno facility for final shredding and documentation. Transport to our facility is preferred for most projects due to power constraints that limit on-site shredding capability at many data center locations.",
        },
        {
        ...
        {
          question:
            "Can Integritrade recover value from data center equipment?",
          answer:
        ...
        {
          question:
            "Does Integritrade handle colocation facility decommissions?",
          answer:
            "Yes. Integritrade works with colocation tenants clearing vacated cages, suites, or floors, as well as with colocation facility operators managing tenant departures or facility upgrades. We coordinate directly with facility management on access requirements, loading dock scheduling, and any specific facility protocols.",
        },
        {
          question:
            "What certifications does Integritrade hold for data center decommissioning?",
          answer:
            "Integritrade holds R2v3 certification, ISO 27001, ISO 14001, ISO 9001, and ISO 45001. R2v3 is recognized by the U.S. Environmental Protection Agency as the benchmark standard for responsible electronics recycling and data destruction. ISO 27001 specifically covers information security management throughout the disposition process.",
        },
        {
          question:
            "How do I get started with a data center decommission in {{CITY}}?",
          answer:
            "Contact Integritrade to schedule a free site walkthrough. Our team will assess the full scope of the project, identify data-bearing assets, evaluate logistics requirements, and provide a fixed project plan with a clear timeline and deliverables. We respond within 24 hours.",
        },
      ],
    },
    {
      heading: "Ready to Decommission Your {{CITY}} Data Center?",
...
Contact Integritrade today to schedule your free site walkthrough and get a fixed plan for your {{CITY}} data center decommission. Our team typically responds within 24 hours.`,
    },
  ],
};
...
const APPLE_EQUIPMENT = {
  ...
  heroHeading:
    "Sell Used Apple Equipment in {{CITY}}: Maximum Value for Your Mac Fleet",
  heroSubheading:
    "Upgrading your company's MacBooks, iMacs, or iPhone fleet in {{CITY}}? Don't settle for trade-in prices or hand your devices to an uncertified buyer. Integritrade is California's most certified buyer of corporate Apple equipment - offering superior buyback rates, NIST 800-88 compliant data erasure, and full chain-of-custody documentation on every single device.",
  details: [
    {
      heading: "",
      body: "Apple products hold their value longer than almost any other IT asset class. We make sure your {{CITY}} organization captures that value - securely, completely, and with the compliance documentation to prove it.",
    },
    {
      heading: "We Buy All Corporate Apple Assets in {{CITY}}",
      bullets: [
    ...
    },
    {
      ...
      bullets: [
        "Intake & Verification: Every device is inventoried, tagged, and confirmed against your asset list. Devices are checked for functionality and confirmed free of iCloud and activation locks before processing begins. Locked devices cannot be sanitized or remarketed - we flag them immediately and work with your {{CITY}} IT team to resolve them before the project moves forward, protecting you from downstream liability.",
        ...
        "Refurbishment & Remarketing: Devices that pass sanitization are graded, refurbished, and remarketed through Integritrade's resale channels - maximizing the recovery value returned to your {{CITY}} organization.",
      ],
    },
    {
      heading: "Why Integritrade for Apple - Not Just Any Buyer?",
      body: `Most recyclers just want the aluminum. We want the technology. By focusing on reuse and remarketing, we consistently return higher value to {{CITY}} businesses than traditional e-waste vendors who default to commodity scrapping.
...
But value recovery is only half the story. The certifications behind our process are what protect your organization:`,
    ...
    {
      heading: "",
      body: "Not many Apple equipment buyers in {{CITY}} or California hold this certification stack.",
    },
    {
      heading: "TraceTech: Real-Time Visibility on Every Apple Device",
      body: "Every Integritrade client receives access to TraceTech, our proprietary AI-integrated asset tracking platform - included at no additional cost. From the moment your Apple devices are picked up in {{CITY}}, your team can monitor their processing status in real time, download Certificates of Erasure and Destruction on demand, and maintain a complete audit-ready compliance record. No waiting on emailed PDFs. No guessing.",
    },
    {
      heading: "The Net-Positive Guarantee",
      body: "For {{CITY}} organizations with 50 or more qualifying devices, Integritrade guarantees a net-positive outcome. Pickup is covered. Data destruction and certification are included. The recovery value from your Apple assets offsets all project costs - meaning your organization gets paid, not billed.",
    },
    {
      heading: "Get the Best Return on Your Apple Investment",
      body: "Ready to sell your Apple equipment in {{CITY}}? Request an Apple asset evaluation today. Our team responds within 24 hours with a no-obligation quote and a fixed plan for secure pickup, certified data destruction, and maximum value recovery from your {{CITY}} location.",
    },
  ],
};
...
// ─────────────────────────────────────────────────────────────────────────────
// SERVICE CATEGORIES
// Existing city service slugs are preserved so live URLs do not change.
// Missing services use the canonical slug from the matching master template.
// ─────────────────────────────────────────────────────────────────────────────
...
const CATEGORIES = [
  ...
  },
  {
    ...
    match: (s) => s.startsWith("it-asset-disposition"),
  },
  {
    template: ELECTRONICS_RECYCLING,
    match: (s) =>
      s === "e-waste-recycling" ||
      s === "electronics-recycling" ||
  ...
  {
    template: CERTIFICATES_OF_DESTRUCTION,
    match: (s) => s === "certificates-of-destruction",
  },
  {
    template: DATA_CENTER_DECOMMISSIONING,
    match: (s) => s === "data-center-decommissioning",
  },
  {
    template: APPLE_EQUIPMENT,
    match: (s) => s === "sell-used-apple-equipment",
  },
];

// ─────────────────────────────────────────────────────────────────────────────
// SOUTHERN CALIFORNIA SERVICE AREA EXPANSION
//
// Added from the latest client request.
// These entries are used only to seed missing city Data.ts files.
// Existing city files are never overwritten by this seed step.
// ─────────────────────────────────────────────────────────────────────────────

const NEW_SERVICE_AREAS = [
  // Los Angeles County
  {
    name: "Los Angeles",
    slug: "los-angeles",
    fileName: "losAngelesData.ts",
    exportName: "losAngelesData",
  },
  {
    name: "Santa Monica",
    slug: "santa-monica",
    fileName: "santaMonicaData.ts",
    exportName: "santaMonicaData",
  },
  {
    name: "Culver City",
    slug: "culver-city",
    fileName: "culverCityData.ts",
    exportName: "culverCityData",
  },
  {
    name: "El Segundo",
    slug: "el-segundo",
    fileName: "elSegundoData.ts",
    exportName: "elSegundoData",
  },
  {
    name: "Torrance",
    slug: "torrance",
    fileName: "torranceData.ts",
    exportName: "torranceData",
  },
  {
    name: "Pasadena",
    slug: "pasadena",
    fileName: "pasadenaData.ts",
    exportName: "pasadenaData",
  },
  {
    name: "Glendale",
    slug: "glendale",
    fileName: "glendaleData.ts",
    exportName: "glendaleData",
  },
  {
    name: "Burbank",
    slug: "burbank",
    fileName: "burbankData.ts",
    exportName: "burbankData",
  },
  {
    name: "Long Beach",
    slug: "long-beach",
    fileName: "longBeachData.ts",
    exportName: "longBeachData",
  },
  ...
  // Orange County
  {
    name: "Irvine",
    slug: "irvine",
    fileName: "irvineData.ts",
    exportName: "irvineData",
  },
  {
    name: "Newport Beach",
    slug: "newport-beach",
    fileName: "newportBeachData.ts",
    exportName: "newportBeachData",
  },
  {
    name: "Costa Mesa",
    slug: "costa-mesa",
    fileName: "costaMesaData.ts",
    exportName: "costaMesaData",
  },
  {
    name: "Anaheim",
    slug: "anaheim",
    fileName: "anaheimData.ts",
    exportName: "anaheimData",
  },
  {
    name: "Santa Ana",
    slug: "santa-ana",
    fileName: "santaAnaData.ts",
    exportName: "santaAnaData",
  },
  {
    name: "Huntington Beach",
    slug: "huntington-beach",
    fileName: "huntingtonBeachData.ts",
    exportName: "huntingtonBeachData",
  },
  ...
  // San Diego County
  {
    name: "San Diego",
    slug: "san-diego",
    fileName: "sanDiegoData.ts",
    exportName: "sanDiegoData",
  },
  {
    name: "La Jolla",
    slug: "la-jolla",
    fileName: "laJollaData.ts",
    exportName: "laJollaData",
  },
  {
    name: "Sorrento Valley",
    slug: "sorrento-valley",
    fileName: "sorrentoValleyData.ts",
    exportName: "sorrentoValleyData",
  },
  {
    name: "Carlsbad",
    slug: "carlsbad",
    fileName: "carlsbadData.ts",
    exportName: "carlsbadData",
  },
  {
    name: "Oceanside",
    slug: "oceanside",
    fileName: "oceansideData.ts",
    exportName: "oceansideData",
  },
  {
    name: "Chula Vista",
    slug: "chula-vista",
    fileName: "chulaVistaData.ts",
    exportName: "chulaVistaData",
  },
  ...
  // Inland Empire — San Bernardino & Riverside Counties
  {
    name: "Ontario",
    slug: "ontario",
    fileName: "ontarioData.ts",
    exportName: "ontarioData",
  },
  {
    name: "Rancho Cucamonga",
    slug: "rancho-cucamonga",
    fileName: "ranchoCucamongaData.ts",
    exportName: "ranchoCucamongaData",
  },
  {
    name: "Riverside",
    slug: "riverside",
    fileName: "riversideData.ts",
    exportName: "riversideData",
  },
  {
    name: "San Bernardino",
    slug: "san-bernardino",
    fileName: "sanBernardinoData.ts",
    exportName: "sanBernardinoData",
  },
  {
    name: "Corona",
    slug: "corona",
    fileName: "coronaData.ts",
    exportName: "coronaData",
  },
];
...
/**
 * Deep-clone a template while replacing every {{CITY}} placeholder.
 */
function fillCity(value, cityName) {
  if (typeof value === "string") {
    return value.replaceAll("{{CITY}}", cityName);
  }

  if (Array.isArray(value)) {
    return value.map((item) => fillCity(item, cityName));
  }
  ...
  if (value && typeof value === "object") {
    ...
    for (const [key, item] of Object.entries(value)) {
      output[key] = fillCity(item, cityName);
    }
...
/**
 * Extract the first field: "value" occurrence from a city data source file.
 */
...
/**
 * Serialize a generated service object back into TypeScript source.
 * Image placeholders are converted back to imported identifiers.
 */
function emitService(service) {
  let json = JSON.stringify(service, null, 2);

  json = json.replace(/"__IMG_(\w+)__"/g, "$1");
...
function emitQuoted(value) {
  return JSON.stringify(value);
}

/**
 * Generates the small starter file required by the existing article generator.
 *
 * The starter contains city-level SEO information and an empty services array.
 * The normal generation pass below then fills it with all approved services.
 */
function createCitySeed(area) {
  ...
  return `// Seeded by scripts/generate-city-articles.mjs.
// Service article content is generated from the approved master templates.

import { ServiceArea } from "./types/serviceAreaTypes";

export const ${area.exportName}: ServiceArea = {
  slug: ${emitQuoted(area.slug)},
  name: ${emitQuoted(area.name)},
  tagline: ${emitQuoted(tagline)},
  metaTitle: ${emitQuoted(metaTitle)},
  metaDescription: ${emitQuoted(metaDescription)},
  intro: ${emitQuoted(intro)},
...
/**
 * Create only the new city files that do not already exist.
 *
 * Important:
 * We intentionally skip existing files so this expansion cannot accidentally
 * destroy city-level SEO information that has already been reviewed.
 */
function createMissingCityFiles() {
  let created = 0;
  let skipped = 0;

  console.log("\nChecking Southern California service-area files...\n");

  for (const area of NEW_SERVICE_AREAS) {
    const fullPath = path.join(AREAS_DIR, area.fileName);

    if (fs.existsSync(fullPath)) {
      console.log(`• ${area.fileName} already exists — skipped`);

      skipped++;
      continue;
    }

    fs.writeFileSync(fullPath, createCitySeed(area), "utf8");

    console.log(`+ created ${area.fileName} (${area.name})`);

    created++;
  }

  console.log(
    `\nSouthern California seed files: ${created} created, ${skipped} already existed.\n`,
  );
}

// Create missing city files before scanning data/areas.
// This ensures new files participate in the same generation run.
createMissingCityFiles();
...
for (const file of files) {
  const fullPath = path.join(AREAS_DIR, file);

  const src = fs.readFileSync(fullPath, "utf8");

  const exportMatch = src.match(/export const (\w+): ServiceArea = \{/);

  if (!exportMatch) {
    warnings.push(`${file}: could not find export — SKIPPED`);
  ...
  const servicesIdx = src.indexOf("services:");

  const headSrc = servicesIdx === -1 ? src : src.slice(0, servicesIdx);

  const servicesSrc = servicesIdx === -1 ? "" : src.slice(servicesIdx);

  const area = {
    slug: extractField(headSrc, "slug"),
  ...
  if (!area.slug || !area.name) {
    warnings.push(`${file}: missing area slug/name — SKIPPED`);
  ...
  /**
   * Read existing service URLs from the city.
   *
   * Existing slugs are intentionally kept because those URLs may already be
   * indexed, linked externally, or included in the sitemap.
   */
  const originalSlugs = [
  ...
  // First preserve any recognized services already present in this city.
  for (const originalSlug of originalSlugs) {
    const category = CATEGORIES.find((candidate) =>
      candidate.match(originalSlug),
    );

    if (!category) {
      warnings.push(
        `${file}: unrecognized service slug "${originalSlug}" — DROPPED, review manually`,
      );

      continue;
    }

    if (assigned.some((item) => item.category === category)) {
      warnings.push(
        `${file}: duplicate category for slug "${originalSlug}" — skipped`,
      );
  ...
  /**
   * Add any approved service categories this city does not yet have.
   *
   * New Southern California cities start with no services, so they receive
   * the complete approved service set during this first generation pass.
   */
  for (const category of CATEGORIES) {
    const alreadyAssigned = assigned.some((item) => item.category === category);
    ...
    assigned.push({
      category,
      slug: category.template.slug,
      added: true,
    });
  }

  // Keep a list of newly created service URLs for sitemap review.
...
if (addedUrls.length) {
  console.log(
    "\nNEW service pages generated — review/add these to the sitemap if needed:",
  );
