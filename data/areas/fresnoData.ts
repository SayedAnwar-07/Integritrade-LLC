...
export const fresnoData: ServiceArea = {
  ...
  services: [
    ...
    },
    {
      ...
      shortDescription:
        "Certified electronics recycling and ITAD in Fresno, CA. R2v3 and ISO-certified, NIST 800-88 data destruction, and full chain-of-custody.",
      icon: "Recycle",
      metaTitle:
        "Electronics Recycling in Fresno, CA | Certified ITAD & Data Destruction | Integritrade",
      metaDescription:
        "Certified electronics recycling & ITAD in Fresno, CA. R2v3 & ISO-certified, NIST 800-88 data destruction, full chain-of-custody. Schedule a secure pickup.",
      image: electronicRecycling,
      heroHeading:
      ...
      details: [
        ...
        },
        {
          ...
          body:
            "Here are some common questions Fresno businesses ask about certified electronics recycling and data destruction.",
          qna: [
            {
            ...
            {
              question: "Do you offer on-site pickup in Fresno?",
              answer:
                "Yes. We schedule secure, chain-of-custody pickups directly from your Fresno location, and can provide a free site walkthrough for larger projects."
            }
          ]
        }
      ]
