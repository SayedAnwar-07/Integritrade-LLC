...
function ServiceTierArticle({
  ...
  const collapsibleCls = [expanded ? 'block' : 'hidden', 'lg:block']
    .join(' ')
    ...
    <article className="grid lg:grid-cols-12 gap-y-10 lg:gap-x-12 py-20 items-start">
      ...
      >
        ...
        <dl>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-x-6 gap-y-2 py-5 border-b border-gray-200 dark:border-gray-800">
          ...
          {/* Collapsible rows — hidden on tablet/mobile until expanded */}
        ...
        <div className="mt-10">
          <Link
            ...
            className={[
              'group inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.20em] font-semibold pb-1.5 border-b transition-all duration-150 click-feel',
              theme?.textLight,
              theme?.textDark,
              theme?.borderLight,
              theme?.borderDark,
