            ...
            <ScrollLoader>
              <section className="mb-16">
                ...
                <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  <p className="custom-text-center">Integritrade operates from a dedicated 31,000 sq ft controlled-access, 24/7 video-monitored ITAD facility with secure staging, industrial pallet racking, dock access, and pallet-handling capability. The facility can securely stage and store more than 1 million pounds of retired IT equipment and electronics each month, supporting corporate refreshes, multi-site collections, data-center projects, returns processing, and large mixed-equipment programs.</p>
